...
@Named
@ViewScoped
public class RelControleFinanceiroVendasMotoboyController extends BaseController {
		...
		if (getEmpresa() == null) { 
			...
			//} else {
				try {
					...
					escreveRelatorioPDF("ControleControleFinanceiroVendas_MotoBoy", true, service.getConnection());
				} catch (Exception e) {
					e.printStackTrace();
