...
public class ReportUtils {
    ...
    /**
     * Indicativo para gera��o no formato XLS.
     */
     ...
     * do tipo XLS. 
     * 
     * @param stream Stream do relat�rio jasper
     * @param parametros Par�metros a ser enviado para o relat�rio
     * @param dataSource Dados utilizados no preenchimento do relat�rio
     * @return
     * @throws JRException Caso haja algum erro no preenchimento do relat�rio
     */
    ...
    public byte[] obterRelatorio(InputStream is, HashMap<String, Object> parametros, List<?> colecaoDataSource, String tipo) throws Exception {
        ...
        if (is == null) {
            throw new Exception("ReportUtils.obterRelatorio(InputStream, HashMap, List, String) : InputStream enviado � nulo");
        }
     ...
     * atrav�s do <code>arquivoJasper</code>.
     * 
     * @param caminhoJasper
     * @param arquivoJasper
     * @param parametros
     ...
     * @param nomeRelatorio nome de sa�da do arquivo no cliente
